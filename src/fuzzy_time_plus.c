...
void update_watch(PblTm* t) {
  ...
  string_format_time(str_bottombar, sizeof(str_bottombar), " %H:%M | uge %V", t);
...
void init_watch(PblTm* t) {
  ...
  string_format_time(str_bottombar, sizeof(str_bottombar), " %H:%M | uge %W", t);
